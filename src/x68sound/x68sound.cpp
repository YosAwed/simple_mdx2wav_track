...
int X68Sound_GetPcm(X68SoundContext *context, void *buf, int len, int c_tr) {
	return context->m_impl->m_opm.GetPcm(buf, len, c_tr);
}
...
extern "C" int X68Sound_GetPcm(void *buf, int len, int c_tr) {
	return opm.GetPcm(buf, len, c_tr);
}
